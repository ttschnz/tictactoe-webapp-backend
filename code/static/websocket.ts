import WebApp, { JSONResponse } from "./webapp.js";
import { Authenticator } from "./game.js";
// TODO: comments
...
export default class WebSocketConnection {
  ...
  createSocket() {
    ...
    this.socket = new WebSocket(
      `${this.socketProtocol}${document.location.host}/ws`
    );
    this.socket.onopen = () => {
    ...
    return new Promise(async (resolve, _reject) => {
      ...
      this.socket.send(
        JSON.stringify({
          ...
          args,
          msgId,
          ...(this.app.credentials && sendCredentials
